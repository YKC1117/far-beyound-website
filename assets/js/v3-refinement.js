(function(){
  ...
  const BRAND_LOGOS={
    zebra:'assets/images/brands/zebra.png',
    argox:'assets/images/brands/argox.png',
    tsc:'assets/images/brands/tsc.png',
    godex:'assets/images/brands/godex.png',
    toshiba:'assets/images/brands/toshiba.png',
    sato:'assets/images/brands/sato.png',
    honeywell:'assets/images/brands/honeywell.png',
    fastech:'assets/images/brands/fastech.svg',
    numa:'assets/images/brands/numa.png',
    datalogic:'assets/images/brands/datalogic.png'
  };
  ...
  function upgradeBrandPortfolio(){
    document.querySelectorAll('.brand-portfolio .brand-wordmark').forEach(a=>{
      ...
      const name=(brandFromHref(a)||a.textContent||'').trim();
      const key=name.toLowerCase().replace(/[^a-z0-9]/g,'');
      let src=BRAND_LOGOS[key];
      let alt=name;
      // The printer line represents legacy Honeywell / Datamax / Intermec equipment.
      if(key==='honeywell' && a.closest('.brand-family') && !a.closest('.brand-family').classList.contains('scanner')){
        src='assets/images/brands/datamax-oneil.png';
        alt='Honeywell (Datamax / Intermec)';
      }
      if(!src)return;
      a.dataset.logoReady='1';
      a.setAttribute('aria-label',name+' 產品');
