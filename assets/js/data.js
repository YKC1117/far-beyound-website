(function () {
  ...
  const defaultData = {
    site: {
      ...
      phones: [{ label: '台北', value: '02-82217759' }, { label: '台南', value: '06-2360139' }],
      fax: '02-82217238', email: 'company@far-beyound.com.tw', line: '@453haosc', address: '新北市中和區中山路二段351號10樓之1'
    },
    categories: [
    ...
    downloads:[
      ...
      {brand:'Zebra',category:'驅動程式',name:'Zebra Printer Driver',version:'依原廠最新版',updated:'—',size:'外部下載',note:'請由下載中心取得最新版；如需協助，歡迎聯絡萬里資訊。'},
      {brand:'Argox',category:'驅動程式',name:'Argox Printer Driver',version:'依原廠最新版',updated:'—',size:'外部下載',note:'請由下載中心取得最新版；如需協助，歡迎聯絡萬里資訊。'},
      {brand:'GoDEX',category:'驅動程式',name:'GoDEX Printer Driver',version:'依原廠最新版',updated:'—',size:'外部下載',note:'請由下載中心取得最新版；如需協助，歡迎聯絡萬里資訊。'},
      {brand:'TOSHIBA',category:'驅動程式',name:'TOSHIBA Printer Driver',version:'依原廠最新版',updated:'—',size:'外部下載',note:'請由下載中心取得最新版；如需協助，歡迎聯絡萬里資訊。'},
      {brand:'SATO',category:'驅動程式',name:'SATO Printer Driver',version:'依原廠最新版',updated:'—',size:'外部下載',note:'請由下載中心取得最新版；如需協助，歡迎聯絡萬里資訊。'},
      {brand:'Honeywell',category:'驅動程式',name:'Honeywell / Datamax / Intermec Driver',version:'依原廠最新版',updated:'—',size:'外部下載',note:'請由下載中心取得最新版；如需協助，歡迎聯絡萬里資訊。'},
