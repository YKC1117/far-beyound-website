(()=>{
  ...
  const UPDATE_INFO={
    updatedAt:'2026/09/15 16:40',
    label:'後台更新',
    entries:[
      {time:'2026/09/15 16:40',type:'載入修正',text:'確認右側單一工作區模組已寫入但 admin.html 仍使用舊版 admin-ux／dashboard 快取參數，導致瀏覽器可能持續載入舊後台。已更新 admin.html 快取版本並直接修正後台 Logo 連結，強制載入最新工作區介面。'},
