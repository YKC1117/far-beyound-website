(()=>{
  ...
  const UPDATE_INFO={
    ...
    label:'後台更新',
    entries:[
      {time:'2026/09/16 09:47',type:'產品管理',text:'新增「匯出已選產品 CSV」：直接沿用產品批次勾選狀態，只匯出實際勾選的產品；未勾選時按鈕保持停用，勾選後會同步顯示筆數。'},
      {time:'2026/09/16 09:47',type:'驗收／版本',text:'後台 QA 新增桌機與 390px 手機的已選產品匯出工具檢查；admin.html、Dashboard fallback、工作區 loader 與 admin-build.json 統一升級為 20260916-0947，避免入口與動態模組混用舊快取。'},
