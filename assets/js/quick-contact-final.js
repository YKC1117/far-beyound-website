  ...
  function install(){
    ...
    style.textContent=`
      ...
      @media(max-width:980px){
        ...
        .mobile-contact-bar a,.mobile-contact-bar button{position:relative!important;min-width:0!important;height:70px!important;min-height:70px!important;padding:8px 8px!important;border:0!important;border-radius:14px!important;display:flex!important;flex-direction:row!important;align-items:center!important;justify-content:center!important;gap:9px!important;color:#fff!important;text-decoration:none!important;font:inherit!important;box-shadow:none!important;overflow:hidden!important;transition:transform .15s ease,filter .15s ease!important}
        ...
        .mobile-contact-bar a:after{white-space:pre-line;text-align:left;font-weight:900;line-height:1.08;letter-spacing:.02em;color:#fff!important}
    ...
    /* Legacy premium CSS is loaded asynchronously; move this final layer to the end once it has arrived. */
    setTimeout(()=>{if(style.isConnected)document.head.appendChild(style)},420);
  }
