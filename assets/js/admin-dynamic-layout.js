(()=>{
  ...
  function polishPasswordPanel(){
    ...
    const notes=[...box.querySelectorAll('.admin-usage-note')];
    const note=notes[0];
  ...
  function arrange(){
    ...
    const version=document.querySelector('.admin-version-note');if(version)version.textContent='後台介面更新：2026/09/12 00:16';
    polishPasswordPanel();fixAnalyticsNote();
  }
