(function(){
  ...
  function addStyle(){
    ...
    style.textContent=`
      /* Final quick-guide polish */
      body[data-page="home"] .fb-service-card:before{
        background:#173f5f!important;
        transform:scaleX(0)!important;
        transform-origin:left center!important;
        opacity:0!important;
      }
      body[data-page="home"] .fb-service-card:hover:before,
      body[data-page="home"] .fb-service-card:focus-within:before{
        transform:scaleX(1)!important;
        opacity:1!important;
      }

      body[data-page="home"] .fb-service-tags{
        gap:7px!important;
      }
      body[data-page="home"] .fb-service-tag,
      body[data-page="home"] .fb-service-tag-link{
      ...
      body[data-page="home"] .fb-service-tag.is-own,
      body[data-page="home"] .fb-service-tag-link.is-own{
        border-color:#d9e4ea!important;
        background:#fff!important;
        color:#35566c!important;
      }
      body[data-page="home"] .fb-service-tag-link:hover{
        border-color:#adc6d3!important;
        background:#f3f8fb!important;
        color:#173f5f!important;
        transform:translateY(-1px)!important;
        box-shadow:0 4px 10px rgba(25,61,86,.06)!important;
      }
      body[data-page="home"] .fb-service-tag-link:focus-visible{
        outline:2px solid #1596b4!important;
        outline-offset:2px!important;
      }
      body[data-page="home"] .fb-service-tag-link:active{
        transform:translateY(0)!important;
        background:#eaf3f7!important;
      }

      body[data-page="home"] .fb-service-title-row{
  ...
  function makeTagsClickable(card,title){
    ...
    [...tags.querySelectorAll('.fb-service-tag')].forEach(tag=>{
      ...
      link.className='fb-service-tag-link';
      link.href=href;
